...
from challenge_utils import challenge_score_v2, dentist_ir, challenge_score_v3
...
TONY_ENDURO_RACE_IN_TICKS = 73 * 1007542 # 73 laps * 1007542 ticks per lap (avg)
